...
#
# 15-441 Checkpoint 2 Script
# 15-441 Staff
#
# If you are connecting to unix.qatar.cmu.edu, you should explicitly specify the server IP address.
# Complaints -> email amtibaa@cmu.edu 
...
echo2.send(s2)
echo3.send(s3)
eval_test(tn, nil, nil, echo3.test_echo(s3),1)
eval_test(tn, nil, nil, echo2.test_echo(s2),1)
eval_test(tn, nil, nil, echo1.test_echo(s1),2)
...
echo3.disconnect()
    ...
    puts "Remember to commit code into tags/checkpoint2 (case sensitive)"
end
